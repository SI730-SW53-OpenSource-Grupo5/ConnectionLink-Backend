...
public record UpdateEventCommand(String title, String description, String profileImageUrl, String bannerImageUrl, Date day, Long categoryId, String username) {
